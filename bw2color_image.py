...
def coloring(file_name):
	...
	ap.add_argument("-i", "--image", type=str, default=file_name,
		help="path to input black and white image")
	ap.add_argument("-p", "--prototxt", type=str, default='model/colorization_deploy_v2.prototxt',
		help="path to Caffe prototxt file")
	ap.add_argument("-m", "--model", type=str, default='model/colorization_release_v2.caffemodel',
		help="path to Caffe pre-trained model")
	ap.add_argument("-c", "--points", type=str, default='model/pts_in_hull.npy',
	...
	im1=cv2.resize(image,(300,300))
	cv2.imshow("Org resize",im1)
	#cv2.imshow("Colorized", colorized)
	im2=cv2.resize(colorized,(300,300))
	cv2.imshow("color resize",im2)
